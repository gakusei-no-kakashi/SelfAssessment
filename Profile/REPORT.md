...
[![Skills](https://img.shields.io/badge/Self_Assessment-179&nbsp;/&nbsp;368&nbsp;/&nbsp;731-009933?style=flat-square)](https://github.com/gakusei-no-kakashi/SelfAssessment/blob/main/Profile/REPORT.md)
...
```
<a href="https://github.com/gakusei-no-kakashi/SelfAssessment/blob/main/Profile/REPORT.md"><img alt="Skills" src="https://img.shields.io/badge/Self_Assessment-179&nbsp;/&nbsp;368&nbsp;/&nbsp;731-009933?style=flat-square"></a>
```
...
Total: you have `6` of `50` skills, `44` to be upgraded, and `2` above needed
...
Total: you have `9` of `75` skills, `66` to be upgraded, and `5` above needed
